...
\caption{This plot shows  the results of the mcmc fit for Compton Y, dust, and the bulk kSZ on a logarithmic y-scale. The priors used were $ 10^{-17} < Y < 10^{-14}, 10^{-19}< D < 10^{-16}$ and $0.001 < kSZ <0.001.$ The resulting best fit parameters were $Y=7.9^{+2.1\times10^{-18}}_{-2.1\times10^{-18}}\times10^{-17}$, $D=5.8^{+3.3\times10^{-19}}_{-3.4\times10^{-19}}\times10^{-18}$, and $kSZ=-4.5\pm0.84\times10^{-18}$, where the errors on Y and D are 1 sigma and the constraint on kSZ is 2 sigma.} %not sure the constraint value is correct
\end{figure}
...
Compton-y & Dust & rSZ & kSZ \\ [0.5ex] 
 ...
 $8.3^{+2.9\times10^{-18}}_{-3.1\times10^{-18}}\times10^{-17}$ & $5.4^{+3.3\times10^{-19}}_{-3.4\times10^{-19}}\times10^{-18}$  & $T_{eff}<1.4\times10^8$ & -- \\[0.25 cm] %$5.4\times10^{-18}^{+3.3\times10^{-19}}_{-3.4\times10^{-19}}$ & <1.4\times10^8 & -- \\[0.25 cm] 
